...
const UUID = process.env.UUID || '38122802-fd5b-4fa9-9425-f42b126b5ed5';
const NEZHA_SERVER = process.env.NEZHA_SERVER || '';      // 哪吒3个变量不全不运行
const NEZHA_PORT = process.env.NEZHA_PORT || '';              // 哪吒端口为{443,8443,2096,2087,2083,2053}其中之一时开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || '';                   // 哪吒客户端密钥
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'bbak.gsef-kmjh-grkp.blog';              // 固定隧道域名，留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiNDU2ZThlODAwNmFiNTMzZDY5NWVhYzE2MTk4ODViMGEiLCJ0IjoiOTgxNzlhMGUtNzkyZS00MGJmLWExZjItYzE3NWMxMjYwMGM1IiwicyI6IllUSXlPR0V5WVRZdFl6UTJOQzAwTXpSaExXSXhOMlV0TW1VeE5HSm1aV0ppWkdZdyJ9';                 // 固定隧道json或token，留空即启用临时隧道
